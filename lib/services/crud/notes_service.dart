...
class NotesService {
  ...
  Future<void> _cacheNotes() async {
    final allNotes = await getListOfNotes();
    _notes = allNotes.toList();
    _notesStreamController.add(_notes);
  }

  Future<Iterable<DatabaseNote>> getListOfNotes() async {
  ...
  Future<DatabaseNote> updateNotes({
    ...
    final noteData = await getNote(id: note.id);
  ...
  Future<void> open() async {
    ...
    try {
      ...
      throw UnableToGetDocumentsDirectiry();
    }
  }
}
